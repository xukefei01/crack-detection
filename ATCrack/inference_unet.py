...
from utils import load_unet_vgg16, load_unet_resnet_101, \
    load_unet_resnet_34, load_AttU_net, \
    load_unet_ecaresnet_34, load_ECAG_net, \
    load_ECAG_vgg16, load_ECA_net, load_ECA_mobile, load_AT_mobile
...
if __name__ == '__main__':
    ...
    parser.add_argument('-model_type', type=str, choices=['vgg16', 'resnet101', 'resnet34', 'AttU_net',
                                                          'ecaresnet34', 'ecagnet', 'ECAG_vgg16', 'ECA_net',
                                                          'ECA_mobile', 'AT_mobile'])
    ...
    if args.model_type == 'vgg16':
        ...
        model = load_AttU_net(args.model_path)
    elif args.model_type == 'ecaresnet34':
        model = load_unet_ecaresnet_34(args.model_path)
    elif args.model_type == 'ecagnet':
        model = load_ECAG_net(args.model_path)
    elif args.model_type == 'ECAG_vgg16':
        model = load_ECAG_vgg16(args.model_path)
    elif args.model_type == 'ECA_net':
        model = load_ECA_net(args.model_path)
    elif args.model_type == 'ECA_mobile':
        model = load_ECA_mobile(args.model_path)
    elif args.model_type == 'AT_mobile':
        model = load_AT_mobile(args.model_path)
    else:
